...
def calculate_lf_response(driver, Vb, Fb, frequencies):
...
def main():
    ...
    print("Calculating LF response...")
    lf_response = calculate_lf_response(lf_driver, Vb, Fb, frequencies)
    ...
    fig = plot_response(
        ...
        f_xo, f3_lf,
        design_name="Flattest Response (Vb=26.5L, Fb=70Hz) - CORRECTED"
    )
