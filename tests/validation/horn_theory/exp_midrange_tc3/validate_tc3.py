...
def calculate_viberesp_response():
    """
    Calculate viberesp response for TC3 system.

    TC3 Parameters (from horn_params.txt):
    ...
    # Create front-loaded horn system with throat chamber
    flh = FrontLoadedHorn(
        driver=driver,
        horn=horn,
...
def compare_results(hr_data, ve_result):
    ...
    """
    print("=" * 70)
    print("TC3 VALIDATION: Driver + Horn + Throat Chamber")
    print("=" * 70)
    print()
...
def save_comparison_data(hr_data, ve_result):
    ...
    with open(output_path, 'w') as f:
        f.write("# TC3 Validation Results\n")
